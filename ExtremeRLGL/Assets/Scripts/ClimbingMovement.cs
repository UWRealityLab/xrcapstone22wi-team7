...
public class ClimbingMovement : MonoBehaviour
{
    ...
    public void handClimbGrab(ClimberHand climbingHand)
    {
        ...
        if (climbingHand.gameObject.GetComponent<XRDirectInteractor>().firstInteractableSelected.transform.CompareTag("ClimbingPoint") && photonView.IsMine)
        {
